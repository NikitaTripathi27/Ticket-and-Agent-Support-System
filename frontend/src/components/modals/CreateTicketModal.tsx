...
import { severityOptions, typeOptions } from "../../utils";

type Schema = z.infer<typeof CreateTicketSchema>;
...
const CreateTicketModal = () => {
  ...
  const { mutateAsync: addTicketMutation } = useMutation({
  ...
  const onSubmit = async (data: Schema) => {
    await addTicketMutation(data);

    createTicketModal.onClose();
      setValue("topic", "");
  ...
  }, [createTicketModal.isOpen, setValue]);
